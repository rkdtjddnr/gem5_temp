...
packet_configs=(
    # [512]="$((53 * 1024 * 1024 * 1024)) $((60 * 1024 * 1024 * 1024)) $((62 * 1024 * 1024 * 1024))"
    # [1024]="$((54 * 1024 * 1024 * 1024)) $((60 * 1024 * 1024 * 1024)) $((62 * 1024 * 1024 * 1024)) $((70 * 1024 * 1024 * 1024))"
    # [1518]="$((55 * 1024 * 1024 * 1024)) $((60 * 1024 * 1024 * 1024)) $((62 * 1024 * 1024 * 1024)) $((70 * 1024 * 1024 * 1024))"
    ...
    [512]="$((70 * 1024 * 1024 * 1024)) $((75 * 1024 * 1024 * 1024)) $((80 * 1024 * 1024 * 1024)) $((90 * 1024 * 1024 * 1024))"
    [1024]="$((75 * 1024 * 1024 * 1024)) $((80 * 1024 * 1024 * 1024)) $((85 * 1024 * 1024 * 1024)) $((90 * 1024 * 1024 * 1024))"
    [1518]="$((75 * 1024 * 1024 * 1024)) $((80 * 1024 * 1024 * 1024)) $((90 * 1024 * 1024 * 1024)) $((92 * 1024 * 1024 * 1024))"
...
# Base command
base_command="./l2fwd-ckp-dpdk-set-1core-1q-multi-port.sh --num-nics 1 --num-queues 1 --script dpdk-testpmd.sh --freq $FREQ"
