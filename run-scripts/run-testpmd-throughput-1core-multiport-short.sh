...
packet_configs=(
    ...
    # [1024]="$((62 * 1024 * 1024 * 1024)) $((65 * 1024 * 1024 * 1024)) $((70 * 1024 * 1024 * 1024))"
    # [1518]="$((62 * 1024 * 1024 * 1024)) $((65 * 1024 * 1024 * 1024)) $((70 * 1024 * 1024 * 1024))"
...
# Base command
base_command="./l2fwd-ckp-dpdk-set-1core-1q-multi-port-short.sh --num-nics 1 --num-queues 1 --script dpdk-testpmd.sh --freq $FREQ"
