...
packet_configs=(
    ...
    # [512]="$((50 * 1024 * 1024 * 1024)) $((53 * 1024 * 1024 * 1024))"
    ...
    # [512]="$((62 * 1024 * 1024 * 1024)) $((65 * 1024 * 1024 * 1024)) $((70 * 1024 * 1024 * 1024))"
    [1024]="$((72 * 1024 * 1024 * 1024)) $((75 * 1024 * 1024 * 1024)) $((80 * 1024 * 1024 * 1024))"
    [1518]="$((72 * 1024 * 1024 * 1024)) $((75 * 1024 * 1024 * 1024)) $((80 * 1024 * 1024 * 1024))"
)
