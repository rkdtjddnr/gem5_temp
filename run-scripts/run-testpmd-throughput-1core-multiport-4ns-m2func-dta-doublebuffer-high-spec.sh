...
packet_configs=(
    ...
    # [48]="$((7 * 1024 * 1024 * 1024)) $((8 * 1024 * 1024 * 1024)) $((9 * 1024 * 1024 * 1024)) $((10 * 1024 * 1024 * 1024)) $((11 * 1024 * 1024 * 1024)) $((12 * 1024 * 1024 * 1024)) $((14 * 1024 * 1024 * 1024))"
    [48]="$((8 * 1024 * 1024 * 1024))"
)
...
# Base command
base_command="./l2fwd-ckp-dpdk-set-1core-1q-multi-port-4ns-m2func-dta-doublebuffer-high-spec.sh --num-nics 1 --num-queues 1 --script dpdk-testpmd.sh --freq $FREQ"
