...
packet_configs=(
    ...
    [48]="$((6 * 1024 * 1024 * 1024))"
    # [48]="$((5 * 1024 * 1024 * 1024)) $((6 * 1024 * 1024 * 1024)) $((7 * 1024 * 1024 * 1024))"
)

FREQ=3GHz

# Base command
base_command="./l2fwd-ckp-dpdk-set-1core-1q-multi-port-4ns-m2func-dta-zerocopy-prev-spec.sh --num-nics 1 --num-queues 1 --script dpdk-testpmd.sh --freq $FREQ"
