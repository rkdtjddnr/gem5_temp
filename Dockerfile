...
RUN apt -y update && apt -y upgrade && \
    ...
    lua5.3 liblua5.3-dev vim libpcap-dev tmux gdb
...
ENV GIT_ROOT=/CXL_network/gem5-nic
ENV RTE_SDK=/CXL_network/gem5-nic/buildroot/package/dpdk/dpdk-source

## For devcontainer, persists bash history
RUN SNIPPET="export PROMPT_COMMAND='history -a' && export HISTFILE=/CXL_network/commandhistory/.bash_history" \
