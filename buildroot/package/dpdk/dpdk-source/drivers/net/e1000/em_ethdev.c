...
eth_em_dev_init(struct rte_eth_dev *eth_dev) //eth_igb_dev_init
{
	...
	// JM - m2func only
	// eth_dev->rx_pkt_burst = (eth_rx_burst_t)&eth_em_recv_pkts_m2func;
	...
	// #ifdef EM_SVE_512
	// printf("EM_SVE_512 defined\n");
	// eth_dev->rx_pkt_burst = (eth_rx_burst_t)&eth_em_recv_pkts_m2func_dta_double_comp_sve512;
	// eth_dev->tx_pkt_burst = (eth_tx_burst_t)&eth_em_xmit_pkts_m2func_dta_double_comp_sve512;
	// #else
	// printf("EM_SVE_512 not defined\n");
	// eth_dev->rx_pkt_burst = (eth_rx_burst_t)&eth_em_recv_pkts_m2func_dta_double_comp;
	// eth_dev->tx_pkt_burst = (eth_tx_burst_t)&eth_em_xmit_pkts_m2func_dta_double_comp;
	// #endif
